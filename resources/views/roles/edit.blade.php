    ...
    <div class="col-xs-8 col-md-6">
      <form action="/roles" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="name" value="{{$rol[0]->name}}" placeholder="Introduzca el nombre que tendra el rol">
          </div>
          <div class="form-group">
            <label for="description">Descripcion</label>
            <textarea class="form-control" name="name" placeholder="Introduzca la descripcion que tendra el rol" rows="3">{{$rol[0]->description}}</textarea>
          </div>
          <div class="row">
            {{$cate = ""}}
